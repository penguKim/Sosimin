...
// ======================== 후기 작성 ========================
	...
	function reviewView(btn) {
		...
		$.ajax({
			...
			success: function(result) {
				console.log(result);
				$("#reviewCheck_" + order_id).html('<ul class="list-group list-group-flush reviewList"></ul>');
				...
				$.ajax({
					...
					success: function(result) {
						if(result == 'true') {
							...
							$(".reviewBtn_" + order_id).remove();
							$(btnParent).append('<input type="button" class="reviewBtn_' + order_id + '" data-id="' + order_id + '" value="거래 후기 작성" data-bs-toggle="modal" data-bs-target="#reviewModal_' + order_id + '" onclick="writeReview(this)">');
