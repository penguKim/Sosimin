	                ...
	                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
	                    <div class="card login-form">
	                        <div class="card-body">
	                            ...
	                            <br>
	                           	<div class="form-group input-group">
	                                ...
	                                <input class="form-control" type="text" id="pay-amount" name="pay_amount"
	                                	placeholder="환급을 원하시는 금액을 입력해주세요" required>
	                            </div>
	                           	<div class="btn-group">
				                ...
				                <!-- 계좌리스트 한 줄 끝 -->
	                            <div class="button">
	                                <button class="btn" id="modal-open" data-bs-toggle="modal" data-bs-target="#password-modal">환급하기</button>
	                            </div>
	                        </div>
	                    </div>
	                </div>
	        ...
	        <div class="modal-dialog">
	            <div class="modal-content">
	                ...
	                <div class="modal-footer button">
	                    <button type="submit" class="btn">환급하기</button>
	                </div>
	            </div>
	        </div>
	    </div>
