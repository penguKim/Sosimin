...
<!-- 									</div> -->
									...
									<div class="datatable-search">
										...
										<input type="button" value="글쓰기" class="btn btn-outline-primary" onclick="location.href='csFaqDetail'">
									</div>
								</div>
									...
									<table class="table datatable datatable-table" id="memberManagementTable">
										<thead>
											<tr>
												...
												<th data-sortable="true">
													<button class="datatable-sorter" style="width: 250px;">제목</button>
												</th>
