								...
								<tbody>
									<c:forEach var="notice" items="${csNoticeList}">
										<tr>
											...
											<td class="green">
												<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-${notice.cs_id}">
													상세보기
												</button>
												<!-- Basic Modal -->
												<div class="modal fade" id="modal-${notice.cs_id}" tabindex="-1">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<h5 class="modal-title">공지사항 상세보기</h5><!-- 모달 제목 -->
