...
<link
	...
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/admin/bootstrap-icons.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/admin/boxicons.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/admin/quill.snow.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/admin/quill.bubble.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/admin/remixicon.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/admin/style2.css"
	rel="stylesheet">
...
<!-- 										</label> -->
								...
								<div class="datatable-container">
									<table class="table datatable datatable-table">
										<thead>
											<tr>
												<th data-sortable="true" style="width: 8%;"><button
												...
												<th data-sortable="true" aria-sort="descending"
													...
													style="width: 5%;"><button
														class="datatable-sorter">아이디</button></th>
												<th data-sortable="true" style="width: 8%;"><button
														class="datatable-sorter">이름</button></th>
												<th data-sortable="true" style="width: 8%;"><button
														class="datatable-sorter">닉네임</button></th>
												<th data-sortable="true" style="width: 20%;"><button
														class="datatable-sorter">이메일</button></th>
												<th data-format="YYYY/DD/MM" data-sortable="true"
													data-type="date" style="width: 8%;"><button
														class="datatable-sorter">생년월일</button></th>
												<th data-sortable="true" style="width: 20%;"><button
														class="datatable-sorter">주소</button></th>
												<th data-sortable="true" style="width: 8%;"><button
														class="datatable-sorter">회원번호</button></th>
												<th data-sortable="true" style="width: 8%;"><button
														class="datatable-sorter">회원레벨</button></th>
												<th data-sortable="true" style="width: 8%;"><button
														class="datatable-sorter">회원상태</button></th>
												<th data-sortable="true" class="red"
													style="width: 2%;"><button
														class="datatable-sorter">관리</button></th>
											</tr>
										</thead>
										<tbody>
											<tr data-index="0">
												...
												<td>Lv.3</td>
												<td>활동</td>
												<td class="green"><input type="button" value="수정"></td>
											</tr>
											<tr data-index="1">
												<td><img width="80px" height="80px"></td>
												<td>UniPugh</td>
...
<!-- 										entries</div> -->
	...
	<!-- Vendor JS Files -->
	<script
		src="${pageContext.request.contextPath}/resources/js/admin/apexcharts.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/admin/bootstrap.bundle.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/admin/chart.umd.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/admin/echarts.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/admin//quill.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/admin/simple-datatables.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/admin/tinymce.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/admin/validate.js"></script>
