		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">상품신고관리</li>
				</ol>
			</nav>
		</div><!-- End Page Title -->
					...
					<div class="card">
						<div class="card-body">
							...
							<table class="comAdmin table table-hover datatable text-center">
								...
								<tbody>
									<c:forEach var="reportList" items="${boardReportList}" varStatus="index">
										<tr>
													...
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<h5 class="modal-title">상품 신고 상세</h5><!-- 모달 제목 -->
